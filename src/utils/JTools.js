/**
 * JTools.js JavaScript 工具包 v1.2.4:
 *
 * 使用文档：http://fiume.cn/jtools/
 * GitHub：https://github.com/zhchjiang95/JTools
 */

(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? (module.exports = factory()) // typeof define === 'function' && define.amd ? define(factory) :
  ...
  function JTools() {
    ...
    this.formatTime = function (options = {}) {
      var sep = options.sep || "-",
        time = options.millisecond ? Number(options.millisecond) : new Date(),
        hours = options.hours || false;
    ...
    this.pageAnchor = function (options) {
      var anchor = options.anchor || 0,
        speed = options.speed || 10,
        down = options.down === undefined ? true : Boolean(options.down);
      (function foo() {
        if (down) {
          if (scrollY < anchor) {
            var scrollTop =
